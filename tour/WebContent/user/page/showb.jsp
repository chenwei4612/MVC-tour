...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt" >
        ...
        <% 
       ArrayList<BusRoute> buss = (ArrayList<BusRoute>)request.getAttribute("buss"); 
           out.print("<table border=2>");
           out.print("<tr>");
           out.println("<th>线路名称</th>");
           out.println("<th>起点</th>");
           out.println("<th>途径</th>");
           out.println("<th>终点</th>");
           out.println("<th>出发时间</th>");
           out.println("<th>到达时间</th>");
           out.print("</tr>");
           for(int i=0 ;i<buss.size();i++){
        	   BusRoute b=buss.get(i); 
	           out.print("<tr>");
	           out.println("<th>"+b.getBus_route_ID()+"</th>");
